...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.cloud_slave_reservation'
        db.add_column('greenfan_job', 'cloud_slave_reservation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cloudslave.Reservation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.physical'
        db.delete_column('greenfan_job', 'physical')

        # Deleting field 'Job.cloud_slave_reservation'
        db.delete_column('greenfan_job', 'cloud_slave_reservation_id')
    ...
    models = {
        ...
        'greenfan.job': {
            ...
            'cloud_slave_reservation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cloudslave.Reservation']", 'null': 'True', 'blank': 'True'}),
            'description': ('jsonfield.fields.JSONField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
