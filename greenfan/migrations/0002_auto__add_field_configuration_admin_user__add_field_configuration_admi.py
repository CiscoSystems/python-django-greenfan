...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.admin_user'
        db.add_column('greenfan_configuration', 'admin_user',
                      self.gf('django.db.models.fields.CharField')(default='localadmin', max_length=200),
                      keep_default=False)

        # Adding field 'Configuration.admin_password'
        db.add_column('greenfan_configuration', 'admin_password',
                      self.gf('django.db.models.fields.CharField')(default='ubuntu', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.admin_user'
        db.delete_column('greenfan_configuration', 'admin_user')

        # Deleting field 'Configuration.admin_password'
        db.delete_column('greenfan_configuration', 'admin_password')
