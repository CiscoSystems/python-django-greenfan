...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.step'
        db.add_column(u'greenfan_job', 'step',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.step'
        db.delete_column(u'greenfan_job', 'step')
    ...
    models = {
        ...
        u'greenfan.job': {
            ...
            'step': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '40', 'null': 'True', 'blank': 'True'})
        },
        u'greenfan.server': {
